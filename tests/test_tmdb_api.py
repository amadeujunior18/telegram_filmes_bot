...
MOCK_SEARCH_MOVIE = {
    "results": [{"id": 872585, "title": "Oppenheimer", "release_date": "2023-07-19", "overview": "Sinopse do Oppenheimer."}]
}
MOCK_DETAILS_MOVIE = {
...
MOCK_SEARCH_TV = {
    "results": [{"id": 100088, "name": "The Last of Us", "first_air_date": "2023-01-15", "overview": "Sinopse de The Last of Us."}]
}
MOCK_DETAILS_TV = {
